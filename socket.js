const {createNewBlock, getBlockchain} = require("./public/blockchain");
...
module.exports = (server)=> {
    ...
    wss.on('connection', (ws, req)=> {
        const ip = req.headers['x-forwarded-for', 'x-Forwarded-Proto'] || req.connection.remoteAddress; // 클라이언트의 IP를 알아내는 유명한 방법 중 하나
